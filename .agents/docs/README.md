...
| 👤 [CUSTOMER_FLOW.md](file:///f:/Coding/Project/sowfkun.verse.v2/.agents/docs/business_flows/CUSTOMER_FLOW.md) | Quản lý khách hàng, mã hóa E2EE/Blind Index SĐT & Email, thuộc tính động, thời hạn xử lý và MongoDB TTL Index. |
