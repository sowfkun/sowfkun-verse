...
export const metadata: Metadata = {
  title: 'Sowfkun Verse DevTools',
  description: 'Sowfkun Verse DevTools — Infra toolbox dùng chung (Redis, Kafka, RabbitMQ, MongoDB, Elasticsearch, PostgreSQL, Git, Webhooks).',
};
