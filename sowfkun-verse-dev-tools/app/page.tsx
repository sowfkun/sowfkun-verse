...
export default function Home() {
  ...
  useEffect(() => {
    ...
    document.title = total > 0 ? `(${total}) Sowfkun Verse DevTools` : 'Sowfkun Verse DevTools';
  }, [wsUnread, zaUnread]);
  ...
  return (
    <div className="shell" data-nav={navPos}>
      ...
      <footer className="appfoot">
        <span>Sowfkun Verse DevTools · infra toolbox dùng chung cho mọi dự án</span>
