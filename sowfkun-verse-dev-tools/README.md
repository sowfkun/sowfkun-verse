# Sowfkun Verse DevTools

**Infra toolbox dùng chung cho hệ sinh thái Sowfkun Verse và các dự án** — một web app Next.js chạy local, quản lý toàn bộ
...
double-click icon ngoài Desktop hoặc nhấn nút Windows gõ "Sowfkun Verse DevTools".
