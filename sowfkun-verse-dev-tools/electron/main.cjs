 ...
 */
const PERSIST_SESSION_HOSTS = process.env.PERSIST_SESSION_HOSTS_REGEX
  ? new RegExp(process.env.PERSIST_SESSION_HOSTS_REGEX, 'i')
  : /(^|\.)(localhost|127\.0\.0\.1|sowfkun\.com)$/i;
...
const SPLASH_HTML = `<body style="margin:0;height:100vh;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:14px;background:#0b0e14;color:#9aa4b2;font:14px system-ui">
  ...
  <div>Sowfkun Verse DevTools đang khởi động…</div>
